...
class Register extends React.Component {
  ...
  constructor(props) {
    ...
    //forçar o componente a sempre registrar estas 
    //funções a cada mudança de state
    //com exceção da função render, todas as 
    //funções criadas em um componente que
    //precisam manipular o state devem ser 
    //registradas no construtor com 'bind'
  ...
  handleSenhaConfirmacao(e) { this.setState
                ...
                result: {
                  erros_validacao: { //limpando erros de validação
                    ...
                    senhaConfirmacao: val.SenhaConfirmacao 
                         !== undefined ? val.SenhaConfirmacao : []
                  }
                }
              });
        ...
        <Card>
          ...
          <form autoComplete="false" method="post" 
            ...
            <Row>
              <Button
                type="submit"
                className="right brown darken-3"
              >
                Realizar Cadastro
            </Button>
            </Row>
